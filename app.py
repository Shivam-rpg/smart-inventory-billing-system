    ...
    with tab3:
        ...
        with st.form("update_customer"):
            ...
            if update_submit:
                ...
                status = Customers().update_customer(
                    customer_id,
                    new_name,
                    new_email,
                    new_phone
    ...
    with tab3:
        ...
        with st.form("update_product"):
            ...
            if update_submit:
                ...
                status = Products().update_product(
                    product_id,
                    new_name,
                    new_description,
                    new_quantity,
...
# ---------------- SALES MANAGEMENT ---------------- #
    ...
    with tab1:
        ...
        try:
            ...
            if customer_data and product_data:
                ...
                if st.button("Generate Sale"):
                    ...
                    if quantity > stock_qty:
                        ...
                        st.success(
                            f"Sale Generated Successfully | Sale ID = {sale_id}"
                        )
            ...
            st.error(f"Sales Management Error: {e}")
